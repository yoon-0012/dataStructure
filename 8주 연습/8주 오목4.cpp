		...
		for (int i = 0; i < 18; ++i)
		{
			if (board[i][j] == 'b' || board[i][j] == 'B')
			{
				...
				for (int h = i + 1; h <= 19; ++h)
				{
					...
					{
						tmpi = i;
						if (thismax > p1max[j + tmpi])
							p1max[j + tmpi] = thismax;
						thismax = 0;
						break;
					}
				}
			...
			else if (board[i][j] == 'w' || board[i][j] == 'W')
			{
				...
				for (int h = i + 1; h <= 19; ++h)
				{
					...
					{
						tmpi = i;
						if (thismax > p2max[j + tmpi])
							p2max[j + tmpi] = thismax;
						thismax = 0;
						break;
					}
				}
		...
		for (int i = 0; i < 18; ++i)
		{
			if (board[i][j] == 'b' || board[i][j] == 'B')
			{
				...
				for (int h = i + 1; h <= 19; ++h)
				{
					...
					{
						tmpi = i;
						if (thismax > p1max[18 - j + tmpi])
							p1max[18 - j + tmpi] = thismax;
						thismax = 0;
						break;
					}
				}
			...
			else if (board[i][j] == 'w' || board[i][j] == 'W')
			{
				...
				for (int h = i + 1; h <= 19; ++h)
				{
					...
					{
						tmpi = i;
						if (thismax > p2max[18 - j + tmpi])
							p2max[18 - j + tmpi] = thismax;
						thismax = 0;
						break;
					}
				}
