	...
	for (int i = 0; i < 19; ++i)
	{
		for (int j = 0; j < 19; ++j)
		{
			if (board[i][j] != '+')
			{
				...
				//if (board[i][j] == 'b' || board[i][j] == 'B')
				//{
				if (board[i][j + 1] == check_ch || board[i][j + 1] == check_ch + 32 || board[i][j + 1] == check_ch - 32)
					++thismax;
				else if (board[i][j + 2] == check_ch && space == FALSE || board[i][j + 2] == check_ch + 32 && space == FALSE || board[i][j + 2] == check_ch - 32 && space == FALSE)
				{
					if (j < 17)
					{
						space = TRUE;
					...
					if (choose == 56)
					{
						if (thismax == 2 || thismax == 3 || thismax == 4 || thismax == 5 || thismax == 6 || thismax == 7)
						{
							...
							for (int check = 0; check < 19; ++check)
							{
								...
								{
									//if (board[check][check2] != check_ch && board[check][check2] != check_ch + 32 && board[check][check2] != check_ch - 32 && board[check][check2] != '+')
									if (turn % 2 != 0)
									{
						...
						if (choose == 56)
						{
							if (thismax == 2 || thismax == 3 || thismax == 4 || thismax == 5 || thismax == 6 || thismax == 7)
							{
								if (turn % 2 != 0)
								{
									...
									else if (j - 1 == 18 && thismax == 2 || space == TRUE && j - thismax - 2 == 0 && thismax == 2 || space == FALSE && j - 1 - thismax == 0 && thismax == 2)
									{
									}
									else
									{
